...
addw (){
    DATA_INPUT="../rootfiles/analysis/merged_HiForestAOD_MC_skim/merged_HiForestAOD_MC_skim.root"
    OUTPUTDIR="../rootfiles/analysis/merged_HiForestAOD_MC_skim_w"
    ...
    OUTPUT="${OUTPUTDIR}/merged_HiForestAOD_MC_skim_w.root"
...
addw2 (){
    ...
    OUTPUTDIR="../rootfiles/analysis/merged_HiForestAOD_DATA_skim_w"
    ACC="../rootfiles/analysis/daniel/ptvsrap/Acc/OutAcc2D.root"
    EFF="../rootfiles/analysis/daniel/ptvsrap/systematic_errors/OutEff2DSyst.root"
    OUTPUT="${OUTPUTDIR}/merged_HiForestAOD_DATA_skim_w.root"
    mkdir -p $( dirname ${OUTPUT})
