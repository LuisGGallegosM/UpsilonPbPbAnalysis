...
INPUT=${1:-"../rootfiles/merged_HiForestAOD_skimmed/merged_HiForestAOD_fit0/merged_HiForestAOD_fit0.root"}

#graphics outputfile named same as input file but with .pdf extension
OUTPUT="${INPUT%.*}.pdf"
#path to draw configuration file
DRAWFILE=${2:-"../rootfiles/merged_HiForestAOD_skimmed/merged_HiForestAOD_skimmed.drawconf"}
