...
OUTPUTFILE="${3:-../rootfiles/analysis/merged_HiForestAOD_DATA_skimjet/unfolding_baseline/unfolding.root}"

mkdir -p "$( dirname ${OUTPUTFILE} )"
./AccEff/acceff -unfold ${INPUTFILE} ${RESPONSEFILE} ${OUTPUTFILE}
